...
class WebsiteCart extends StatefulWidget {
  const WebsiteCart({Key key}) : super(key: key);

  @override
  _WebsiteCartState createState() => _WebsiteCartState();
}

class _WebsiteCartState extends State<WebsiteCart> {
  @override
